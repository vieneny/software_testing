...
- [面试题库平台与离线版：485 道详解题、2025 第一版整理、来源分组与全流程模拟](docs/08-求职备考/04-面试题库/README.md)
...
原仓库中的两版面试大纲和旧版 HTML 已迁入题库的[历史资料目录](docs/08-求职备考/04-面试题库/历史资料/README.md)。2025 第一版 175 题已经净化、补全答案并接入平台；同一份统一数据还会生成无需服务的离线 HTML。

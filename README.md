...
- [面试题库平台与离线版：470 道详解题、2025 优化修订版、来源分组与全流程模拟](docs/08-求职备考/04-面试题库/README.md)
...
原仓库中的 2025 优化修订版大纲和旧版 HTML 答案线索已迁入题库的[历史资料目录](docs/08-求职备考/04-面试题库/历史资料/README.md)。修订版 160 题已经净化、补全详细答案和答题思路并接入平台；同一份统一数据还会生成无需服务的离线 HTML。

...
* 编写步骤：
  ...
  9. 定义 float类型变量f4 和 double类型变量d4  2.59999999
...
> 课程配图（未随笔记提交）：1557879464870

* 编写步骤：
  1. 定义类Test7
  2. 定义main方法
  3. 定义一个int类型变量week，赋值为2
  4. 修改week的值，在原值基础上加上100  week+=100   week7
...
​       1）可以被4整除，但不可被100整除  (year%4==0 && year%1!=0)  || (year %400==0)

​       2）可以被400整除

* 按步骤编写代码，效果如图所示：

> 课程配图（未随笔记提交）：1557902649882

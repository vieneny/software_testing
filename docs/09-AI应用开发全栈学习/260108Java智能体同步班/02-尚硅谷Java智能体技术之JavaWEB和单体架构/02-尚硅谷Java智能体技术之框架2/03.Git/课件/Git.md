...
> 课程配图（未随笔记提交）：image-20230627170844640
...
> 课程配图（未随笔记提交）：image-20230627131721466

结果查看

> 课程配图（未随笔记提交）：image-20230627131804454
...
> 课程配图（未随笔记提交）：image-20230627132109306

#### （2）新增文件

> 课程配图（未随笔记提交）：image-20230627132215734

> 课程配图（未随笔记提交）：image-20230627132317963

####  （3）再次查看（检测到未追踪文件）

> 课程配图（未随笔记提交）：image-20230627132547573
...
> 课程配图（未随笔记提交）：image-20230627132954523



### 4.2 查看状态（检测到暂存区有新文件）

> 课程配图（未随笔记提交）：image-20230627133040699
...
> 课程配图（未随笔记提交）：image-20230627133335748

### 5.2 查看状态（没有文件需要提交）

> 课程配图（未随笔记提交）：image-20230627133425162
...
> 课程配图（未随笔记提交）：image-20230627133644105



### 6.2 将修改的文件再次添加暂存区

> 课程配图（未随笔记提交）：image-20230627133907417



### 6.3 查看状态（工作区的修改添加到了暂存区）

> 课程配图（未随笔记提交）：image-20230627133937432



### 6.4 将暂存区文件提交到本地库

> 课程配图（未随笔记提交）：image-20230627134046013
...
> 课程配图（未随笔记提交）：image-20230627134228811
...
> 课程配图（未随笔记提交）：image-20230627134422376



--切换到之前版本，8ca80d7版本，也就是我们第一次提交的版本

> 课程配图（未随笔记提交）：image-20230627134533136



--切换完毕之后再查看历史记录，当前成功切换到了8ca80d7版本

> 课程配图（未随笔记提交）：image-20230627134618381



--然后查看文件hello.txt，发现文件内容已经变化

> 课程配图（未随笔记提交）：image-20230627134649667
...
> 课程配图（未随笔记提交）：image-20230627135136847
...
> 课程配图（未随笔记提交）：image-20230627135331197
...
> 课程配图（未随笔记提交）：image-20230627160605046

--添加暂存区

> 课程配图（未随笔记提交）：image-20230627160641155

--提交本地库

> 课程配图（未随笔记提交）：image-20230627160720264

--查看分支

> 课程配图（未随笔记提交）：image-20230627160758345

 --查看master分支上的文件内容

> 课程配图（未随笔记提交）：image-20230627160840253
...
> 课程配图（未随笔记提交）：image-20230627161146988

--查看hot-fix分支上的文件内容发现与master分支上的内容不同

> 课程配图（未随笔记提交）：image-20230627161238145

--在hot-fix分支上做修改

> 课程配图（未随笔记提交）：image-20230627161342861

--添加暂存区

> 课程配图（未随笔记提交）：image-20230627161412040

--提交本地库

> 课程配图（未随笔记提交）：image-20230627161502384
...
> 课程配图（未随笔记提交）：image-20230627161644314

 -- 在master分支上合并hot-fix分支

> 课程配图（未随笔记提交）：image-20230627161728843
...
> 课程配图（未随笔记提交）：image-20230627161807459
...
> 课程配图（未随笔记提交）：image-20230627161950153
...
> 课程配图（未随笔记提交）：image-20230627162115286

#### （2）添加到暂存区

> 课程配图（未随笔记提交）：image-20230627162209093

#### （3）执行提交

注意：此时使用git commit命令时**不能带文件名**

> 课程配图（未随笔记提交）：image-20230627162314679
...
> 课程配图（未随笔记提交）：image-20230627163438184



> 课程配图（未随笔记提交）：image-20230627163519780
...
> 课程配图（未随笔记提交）：image-20230627163625061

**https://gitee.com/boncda/git-demo1.git**

***\*这个地址在创建完远程仓库后生成的连接，如图所示红框中\****

> 课程配图（未随笔记提交）：image-20230627163710074
...
> 课程配图（未随笔记提交）：image-20230627163829931

第一次需要输入**码云的用户名和密码**

此时发现已将我们master分支上的内容推送到Gitee创建的远程仓库。

> 课程配图（未随笔记提交）：image-20230627163920349
...
> 课程配图（未随笔记提交）：image-20230627164105896

 这个地址为远程仓库地址，克隆结果：初始化本地仓库

> 课程配图（未随笔记提交）：image-20230627164135658

进入git-demo1执行

> 课程配图（未随笔记提交）：image-20230627164353109
...
> 课程配图（未随笔记提交）：image-20230627171100646



## 3 初始化本地库

> 课程配图（未随笔记提交）：image-20230627171156663

 选择要创建Git本地仓库的工程。

> 课程配图（未随笔记提交）：image-20230627171258993
...
> 课程配图（未随笔记提交）：image-20230627171351854



## 5 **提交到本地库**

> 课程配图（未随笔记提交）：image-20230627171511686
...
> 课程配图（未随笔记提交）：image-20230627192612272

自定义远程库链接。

> 课程配图（未随笔记提交）：image-20230627192704469

给远程库链接定义个name，然后再URL里面填入码云远程库的链接即可

> 课程配图（未随笔记提交）：image-20230627192906905

然后选择定义好的远程链接，点击Push即可

> 课程配图（未随笔记提交）：image-20230627192951068

 去码云远程库查看代码。

> 课程配图（未随笔记提交）：image-20230627193119142
...
> 课程配图（未随笔记提交）：image-20230627193357500

（2）右键点击项目，可以将远程仓库的内容pull到本地仓库。

> 课程配图（未随笔记提交）：image-20230627193430355

（3）选择远程库

> 课程配图（未随笔记提交）：image-20230627193601024

（4）pull了远程库中最新内容

> 课程配图（未随笔记提交）：image-20230627193719625
...
> 课程配图（未随笔记提交）：image-20230627194402118

（2）输入远程码云仓库地址

> 课程配图（未随笔记提交）：image-20230627194205652

（3）完成clone操作

> 课程配图（未随笔记提交）：image-20230627194316698

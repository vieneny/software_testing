...
> 课程配图（未随笔记提交）：image-20251215162812362

**正向代理：**如果把局域网外的Internet想象成一个巨大的资源库，则局域网中的客户端要访问Internet，则需要通过代理服务器来访问，这种代理服务就称为正向代理。

> 课程配图（未随笔记提交）：image-20251215163254338
...
> 课程配图（未随笔记提交）：image-20250616161747024
...
> 课程配图（未随笔记提交）：image-20250616161803707
...
> 课程配图（未随笔记提交）：image-20250616161814054
...
> 课程配图（未随笔记提交）：image-20250616161848468
...
> 课程配图（未随笔记提交）：image-20250616161838080
...
> 课程配图（未随笔记提交）：image-20250616161859995
...
> 课程配图（未随笔记提交）：image-20251215140303754
...
> 课程配图（未随笔记提交）：image-20250616161938255
...
> 课程配图（未随笔记提交）：image-20251215145524899
...
> 课程配图（未随笔记提交）：image-20250620235705401)



* **通过idea修改启动网关端口号**

> 课程配图（未随笔记提交）：image-20251215143825935

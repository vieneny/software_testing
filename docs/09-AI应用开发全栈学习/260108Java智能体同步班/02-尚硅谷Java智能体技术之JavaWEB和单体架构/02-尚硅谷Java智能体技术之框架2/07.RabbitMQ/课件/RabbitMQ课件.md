...
> 课程配图（未随笔记提交）：image-20251215151925394
...
> 课程配图（未随笔记提交）：image-20240805155818298

* 而采用消息队列方式，可以很好的解决耦合度过高问题

> 课程配图（未随笔记提交）：image-20240805160108001
...
> 课程配图（未随笔记提交）：image-20251215151243211

**(2)** **并行方式：**

将注册信息写入数据库后，发送邮件的同时，发送短信，以上三个任务完成后，返回给客户端，并行的方式能提高处理的时间。

> 课程配图（未随笔记提交）：image-20251215150934153
...
> 课程配图（未随笔记提交）：image-20251215150642276
...
> 课程配图（未随笔记提交）：image-20251217095309149
...
> 课程配图（未随笔记提交）：image-20251217095542135
...
> 课程配图（未随笔记提交）：image-20251217094744438
...
> 课程配图（未随笔记提交）：image-20251217100048045

### 6.2 RabbitMQ基础架构

* **基础架构图**

> 课程配图（未随笔记提交）：image-20240806102134889
...
> 课程配图（未随笔记提交）：image-20231102194452610



使用上面创建Docker容器时指定的默认用户名、密码登录：

> 课程配图（未随笔记提交）：image-20231102194633997



> 课程配图（未随笔记提交）：image-20231102194746743
...
> 课程配图（未随笔记提交）：image-20240806084908636



## 2 创建队列

> 课程配图（未随笔记提交）：image-20240725175936170



队列名称：atguigu.queue.simple

> 课程配图（未随笔记提交）：image-20240725180208216
...
> 课程配图（未随笔记提交）：image-20251215111735300
...
> 课程配图（未随笔记提交）：image-20251215111028243
...
> 课程配图（未随笔记提交）：image-20240725193430307
...
> 课程配图（未随笔记提交）：image-20251215111325460
...
> 课程配图（未随笔记提交）：image-20240725194639024
...
> 课程配图（未随笔记提交）：image-20240806102313708
...
> 课程配图（未随笔记提交）：image-20240806084946234
...
> 课程配图（未随笔记提交）：image-20240725203346015



> 课程配图（未随笔记提交）：image-20240725203322613
...
> 课程配图（未随笔记提交）：image-20240806085107277
...
> 课程配图（未随笔记提交）：image-20240806085123819
...
> 课程配图（未随笔记提交）：image-20240725210428356

> 课程配图（未随笔记提交）：image-20240725210526288



#### 3 创建队列并绑定交换机

> 课程配图（未随笔记提交）：image-20240725210906899



> 课程配图（未随笔记提交）：image-20240725211118200



此时可以到交换机下查看绑定关系：

> 课程配图（未随笔记提交）：image-20240725211206904
...
> 课程配图（未随笔记提交）：image-20240725212632041
...
> 课程配图（未随笔记提交）：image-20240806085148987
...
> 课程配图（未随笔记提交）：image-20240725214547261

> 课程配图（未随笔记提交）：image-20240725214608820
...
> 课程配图（未随笔记提交）：image-20240725215245500
...
> 课程配图（未随笔记提交）：image-20240806085214905
...
> 课程配图（未随笔记提交）：image-20240725220957833



#### 3 绑定关系

> 课程配图（未随笔记提交）：image-20240725222339828

> 课程配图（未随笔记提交）：image-20240725222805072
...
> 课程配图（未随笔记提交）：image-20240725223737173
...
> 课程配图（未随笔记提交）：image-20240806085244893
...
> 课程配图（未随笔记提交）：image-20240806085305207
...
> 课程配图（未随笔记提交）：image-20240806085325073
...
需要设置类型为direct的交换机，交换机和队列进行绑定，并且指定routing key，当发送消息到交换机后，交换机会根据routing key将消息发送到对应的队列
 ...
 > 课程配图（未随笔记提交）：image-20240806085354471
...
需要设置类型为topic的交换机，交换机和队列进行绑定，并且指定通配符方式的routing key，当发送消息到交换机后，交换机会根据routing key将消息发送到对应的队列
 ...
 > 课程配图（未随笔记提交）：image-20240806085413115
...
> 课程配图（未随笔记提交）：image-20240806092424473

* **故障情况1：**

> 课程配图（未随笔记提交）：image-20240806092503472
...
> 课程配图（未随笔记提交）：image-20240806092558221
...
> 课程配图（未随笔记提交）：image-20240806092653865
...
> 课程配图（未随笔记提交）：image-20231106192621173



创建之后，可以在列表中看到：

> 课程配图（未随笔记提交）：image-20231106192708597



#### 2、创建非持久化队列

> 课程配图（未随笔记提交）：image-20231106195216265



创建之后，可以在列表中看到：

> 课程配图（未随笔记提交）：image-20231106195132627



#### 3、绑定

> 课程配图（未随笔记提交）：image-20231106195748319
...
#### > 课程配图（未随笔记提交）：image-20231106200245531
...
> 课程配图（未随笔记提交）：image-20231106200934265
...
> 课程配图（未随笔记提交）：image-20231106201123268
...
> 课程配图（未随笔记提交）：image-20240806094300945
...
> 课程配图（未随笔记提交）：image-20231107155915253
...
> 课程配图（未随笔记提交）：image-20231107160233539
...
> 课程配图（未随笔记提交）：image-20231107160820062

- 接下来启动消费端程序，持续观察队列情况：

> 课程配图（未随笔记提交）：image-20231107160922632



> 课程配图（未随笔记提交）：image-20231107160936216



> 课程配图（未随笔记提交）：image-20231107160951639
...
> 课程配图（未随笔记提交）：image-20240806094631068
...
> 课程配图（未随笔记提交）：image-20231107162548129



别忘了设置绑定关系：

> 课程配图（未随笔记提交）：image-20231107162705883
...
> 课程配图（未随笔记提交）：image-20231107163052001
...
> 课程配图（未随笔记提交）：image-20231107163534385
...
> 课程配图（未随笔记提交）：image-20251215163717901
...
> 课程配图（未随笔记提交）：image-20240318165821774
...
> 课程配图（未随笔记提交）：image-20240318165927279
...
> 课程配图（未随笔记提交）：image-20231107170523503
...
> 课程配图（未随笔记提交）：image-20231107171231765
...
> 课程配图（未随笔记提交）：image-20231107172002297



因为没有消费端监听程序，所以消息未超时前滞留在队列中：

> 课程配图（未随笔记提交）：image-20231107172234849



消息超时后，进入死信队列：

> 课程配图（未随笔记提交）：image-20231107172042460
...
> 课程配图（未随笔记提交）：image-20251217100731579
...
> 课程配图（未随笔记提交）：image-20251217101326993
...
> 课程配图（未随笔记提交）：image-20231107180045135
...
> 课程配图（未随笔记提交）：image-20240321115348525



确认点2：如果创建新交换机时可以在type中看到x-delayed-message选项，那就说明插件安装好了

> 课程配图（未随笔记提交）：image-20231107181914265
...
> 课程配图（未随笔记提交）：image-20240319163915574
...
> 课程配图（未随笔记提交）：image-20240319171359652
...
> 课程配图（未随笔记提交）：image-20240321115605608



##### ③消费者端效果

> 课程配图（未随笔记提交）：image-20240321115646548
...
> 课程配图（未随笔记提交）：image-20251217093113569
...
> 课程配图（未随笔记提交）：image-20251217093257831

...
<img src="images/pay.gif" alt="pay" style="zoom:67%;" />
...
![image-20230709160020998](images/image-20230709160020998.png)

手机网站支付是指商家在移动端网页展示商品或服务，用户在商家页面确认使用支付宝支付后，浏览器自动跳转支付宝 App 或支付宝网页完成付款的支付产品。该产品在签约完成后，需要技术集成方可使用。

（2）使用示例

![image-20240729101520075](images/image-20240729101520075.png)
...
![image-20230709170008020](images/image-20230709170008020.png)
...
![image-20230709170626255](images/image-20230709170626255.png)

2、非对称加密：加密和解密使用的是不同的秘钥

![image-20230709170703058](images/image-20230709170703058.png)

支付宝为了提供数据传输的安全性使用了两个秘钥对：

![image-20230709170850260](images/image-20230709170850260.png)
...
![image-20230709164753985](images/image-20230709164753985.png)
...
![image-20230710180507583](images/image-20230710180507583.png)
...
![image-20230710185519318](images/image-20230710185519318.png)
...
<img src="images/image-20230219170135784.png" alt="image-20230219170135784" style="zoom:67%;" />

3、购买二级域名，绑定隧道

![image-20230219170206186](images/image-20230219170206186.png)

4、下载客户端

![image-20230219170337316](images/image-20230219170337316.png)
...
![image-20230219171016742](images/image-20230219171016742.png)

...
开始本模块前，建议先完成独立的 [AI 应用开发全栈学习](../09-AI应用开发全栈学习/README.md)。其中的 `260108Java智能体同步班` 笔记集中覆盖 Java、Web、单体架构、基础中间件和一个完整业务项目；本模块在此基础上进入 Spring AI、RAG、Agent、评测、安全与部署。两块内容保持独立，课程笔记不会拆散到本模块各章节。

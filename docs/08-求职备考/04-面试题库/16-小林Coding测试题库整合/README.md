...
>
本轮不是把外部题库复制到仓库，而是完成了“页面盘点 → 与现有题库去重 → 发现能力缺口 → 原创重写 → 官方资料校验 → 离线题库可追溯展示”的闭环。
...
- [离线面试题库](../../../../apps/interview-bank/README.md)：直接打开、筛选、收藏和分页复习。

## 六、在离线题库中查看

直接打开 `apps/interview-bank/offline/软件测试离线题库.html`，选择“后续整理：公开资料重构”来源查看 62 道新增题。21 个页面的题量与映射审计保留在本目录 Markdown 和 `apps/interview-bank/data/xiaolincoding-coverage.json` 中。

...
一个面向个人学习的 FastAPI + Vue 软件测试面试题库，同时提供无需启动服务的单文件离线版。网站把个人整理最新版、10 个 Markdown 专题、2026 公开面经重构题、补充评审题和公开测试/测开资料的去重重构结果组织成可检索、可练习、可复盘的小型应用。

## 当前内容

- 172 道原有核心详解题；
- 160 道个人整理最新版详解题，均已补全详细答案与答题思路；
- 24 道 2026-07 最新趋势原创重构题；
- 52 道独立设计并交叉校验的补充详解题；
- 62 道根据小林 Coding 业务、自动化、性能与测开基础资料去重后新增的详解题；
- 共 470 道可筛选、可查看详细答案的题；
- 个人整理最新版大纲共 160 条逐项覆盖记录，全部关联到已确认答案；
- 21 篇小林 Coding 页面全部进入覆盖清单，共核对 672,610 个正文字符；站内标称 1,143 题与当前可见 1,111 题分开记录；
- 来源目录共 101 条，其中 98 条带公开 URL；62 道公开资料重构题均至少有一个独立标准、官方文档或方法原始来源核验；
...
个人整理最新版 JSON 是这 160 道题的唯一答案源，题目大纲只用于逐题覆盖校验。
...
离线版和平台版使用同一份 `questions.json`，包含全部 470 题，并按“个人整理最新版”和四组后续内容划分来源。支持关键词、模块、来源和收藏筛选；收藏只保存在当前浏览器。
...
- 个人整理最新版 160 题全部有详细答案与独立答题思路，并进入平台和离线版；
- 160 条大纲记录全部完成覆盖校验；强匹配与待复核分开统计；
...
| `GET` | `/api/v1/legacy-coverage` | 查看个人整理最新版 160 道题的覆盖校验结果 |
